        ...
        return(
            <View style = {styles.container}>
                ...
                <ScrollView style = {styles.screen} contentContainerStyle = {{alignItems: 'center'}}>
                    ...
                    <Text style = {styles.guide}>4. If you find remembering your passwords difficult, <Text style = {{color: '#841DFA'}}>Safe Pass</Text> will store them for you so that view them later.</Text>
                </ScrollView>
            </View>
        )
    }
